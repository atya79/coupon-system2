...
CREATE TABLE `company_coupon` (
  ...
  Coup_ID bigint(255) DEFAULT NULL
)
ENGINE = InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

ALTER TABLE `company_coupon` ADD INDEX comp_ind(Comp_ID), ADD INDEX coup_ind(Coup_ID);
...
ALTER TABLE `company_coupon`
  ADD CONSTRAINT FK_coup_id FOREIGN KEY (Coup_ID)
   REFERENCES coupon(Coup_id) ON DELETE CASCADE;
--
--
--
...
CREATE TABLE `customer_coupon` (
  ...
  `Coup_ID` bigint(255) NOT NULL,
  PRIMARY KEY (`Cust_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

ALTER TABLE `customer_coupon`
  ADD CONSTRAINT FK_cou_id FOREIGN KEY (Coup_ID)
   REFERENCES coupon(Coup_id) ON DELETE CASCADE;
--
...
CREATE TABLE `company` (
  `Comp_ID` bigint(255) NOT NULL AUTO_INCREMENT,
